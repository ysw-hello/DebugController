...
//        [self.requestSerializer setValue:@"Asia/Shanghai" forHTTPHeaderField:@"X-VUNGLE-TIMEZONE"];
//        [self.requestSerializer setValue:@"zh-Hans-CN" forHTTPHeaderField:@"X-VUNGLE-LANGUAGE"];
//        [self.requestSerializer setValue:@"com.bulletproof.happyguy" forHTTPHeaderField:@"X-VUNGLE-BUNDLE-ID"];
        
        [self.requestSerializer setValue:@"Trippy%20Hippy/38 CFNetwork/808.3 Darwin/16.3.0" forHTTPHeaderField:@"User-Agent"];
